...
class RegistrationForm(Form):
    ...
    def validate_email(self, field):
        if collection_user.User.find_one({'email': field.data}):
...
class PasswordResetRequestForm(Form):
    ...
    def validate_email(self, field):
        if collection_user.User.find_one({'email': field.data}) is None:
...
class ChangeEmailForm(Form):
    ...
    def validate_email(self, field):
        if collection_user.User.find_one({'email': field.data}) is not None:
